...
namespace HRProject_NTier.WEBUI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //services.AddDbContext<ProjectContext>(options => options.UseSqlServer("Server=.; database=HRMDB7; uid=yusuf; pwd=123"));
            ...
            services.AddTransient<IVisitorCommentsRepository, VisitorCommentsRepository>();
          
            //ekle
            services.AddTransient<IPaymentRepository, PaymentRepository>();
            services.AddTransient<ISpendingRepository, SpendingRepository>();
            services.AddTransient<IPersonnelRaporRepository, PersonnelRaporRepository>();
