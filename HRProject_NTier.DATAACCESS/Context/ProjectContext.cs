...
namespace HRProject_NTier.DATAACCESS.Context
{
    public class ProjectContext : DbContext
    {
        ...
        public DbSet<VisitorComments> VisitorComments { get; set; }
        public DbSet<PersonnelRapor> PersonnelRapors { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<VisitorComments>().HasKey(vc => vc.CommentsID);
            modelBuilder.Entity<PersonnelRapor>().HasKey(pr => pr.ID);
            modelBuilder.Entity<Payment>().Property(x => x.CreatedDate).HasDefaultValueSql("getdate()");
            modelBuilder.Entity<Spending>().Property(x => x.CreatedDate).HasDefaultValueSql("getdate()");
