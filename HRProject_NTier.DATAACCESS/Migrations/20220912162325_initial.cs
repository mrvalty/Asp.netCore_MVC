        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ManagerMailBody = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                name: "PersonnelRapors",
                columns: table => new
                {
                    ID = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    TotalPermission = table.Column<int>(nullable: true),
                    TotalAdvance = table.Column<int>(nullable: true),
                    PersonnelID = table.Column<int>(nullable: true),
                    ManagerID = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PersonnelRapors", x => x.ID);
                    table.ForeignKey(
                        name: "FK_PersonnelRapors_Managers_ManagerID",
                        column: x => x.ManagerID,
                        principalTable: "Managers",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PersonnelRapors_ManagerID",
                table: "PersonnelRapors",
                column: "ManagerID");
