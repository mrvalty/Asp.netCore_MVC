...
namespace HRProject_NTier.DATAACCESS.Repositories.Concrete
{
    public class ManagerCommentRepository : IManagerCommentRepository
    {
        ...
        public bool DeleteComment(ManagerComment managerComment)
        {
            _context.Entry(managerComment).State = EntityState.Modified;
            return _context.SaveChanges() > 0;
        }
        public bool UpdateComments(ManagerComment managerComment)
        {
            _context.Entry(managerComment).State = EntityState.Modified;
            return _context.SaveChanges() > 0;
        }
